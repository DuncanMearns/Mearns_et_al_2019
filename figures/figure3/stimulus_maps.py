...
averages = np.load(os.path.join(stimulus_map_directory, 'module_averages.npy'))[..., 1:251]
histograms = np.load(os.path.join(stimulus_map_directory, 'module_histograms.npy'))
...
for i in range(7):
    ...
    save_fig(fig, 'figure3', 'stimulus_maps_{}'.format(i))
