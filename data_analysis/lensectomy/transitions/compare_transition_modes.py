...
if __name__ == "__main__":
    ...
    control_matrices = np.load(os.path.join(transition_directory, 'control', 'smoothed_transition_matrices.npy'))
    unilateral_matrices = np.load(os.path.join(transition_directory, 'unilateral', 'smoothed_transition_matrices.npy'))
