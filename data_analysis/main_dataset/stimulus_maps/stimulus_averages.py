...
if __name__ == "__main__":
    ...
    np.save(os.path.join(stimulus_map_directory, 'module_histograms.npy'), module_histograms)
    ...
    np.save(os.path.join(stimulus_map_directory, 'module_averages.npy'), module_averages)
